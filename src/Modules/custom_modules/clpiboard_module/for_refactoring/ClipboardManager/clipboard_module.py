...
class ClipboardManager(QMainWindow):
    ...
    def init_ui(self):
        ...
        header_label = QLabel("📋 Historia Schowka")
        ...
        self.status_label.setStyleSheet(
            "font-size: 11pt; padding: 8px; background-color: #4CAF50; color: white; "
        ...
        self.toggle_monitor_btn.setStyleSheet(
            "font-size: 11pt; padding: 8px 15px; background-color: #FF9800; "
        ...
        # Pasek statusu
        self.statusBar().showMessage(f"Historia: {len(self.history)} elementów")
    ...
    def create_left_panel(self):
        ...
        btn_copy.setStyleSheet("background-color: #2196F3; color: white; padding: 8px;")
    ...
    def create_right_panel(self):
        ...
        self.info_label.setStyleSheet("font-weight: bold; padding: 5px; background-color: #E3F2FD; border-radius: 4px;")
        ...
        self.ai_note_btn.setStyleSheet(
    ...
    def update_monitoring_ui(self):
        ...
        if self.monitoring_active:
            ...
            self.status_label.setStyleSheet(
                "font-size: 11pt; padding: 8px; background-color: #f44336; color: white; "
                "border-radius: 4px; font-weight: bold;"
            )
            self.toggle_monitor_btn.setText("▶ Uruchom")
            self.toggle_monitor_btn.setStyleSheet(
                "font-size: 11pt; padding: 8px 15px; background-color: #4CAF50; "
                "color: white; border: none; border-radius: 4px; font-weight: bold;"
            )
    ...
    def refresh_history_list(self):
        ...
        # Przygotuj kolor dla przypiętych (jednorazowo)
        pinned_color = QColor(255, 248, 220)
    ...
    def add_item_to_list(self, item, insert_at_top=False):
        ...
        # Koloruj przypięte
        if item.pinned:
            list_item.setBackground(QColor(255, 248, 220))
    ...
    def copy_to_clipboard(self):
        ...
        self.statusBar().showMessage(f"Skopiowano: {clipboard_item.preview}", 3000)
    ...
    def toggle_pin(self):
        ...
        self.statusBar().showMessage(f"Element {status}", 2000)
    ...
    def delete_item(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            self.update_stats()
            self.save_data()
            self.statusBar().showMessage("Element usunięty", 2000)
    ...
    def clear_history(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            self.update_stats()
            self.save_data()
            self.statusBar().showMessage("Historia wyczyszczona", 2000)
    ...
    def update_stats(self):
        ...
        self.statusBar().showMessage(f"Historia: {total} elementów")
    ...
    def _show_ai_note_dialog(self, content_type, content):
        ...
        header.setStyleSheet("font-size: 14pt; font-weight: bold; padding: 10px; background-color: #E3F2FD;")
        ...
        info_label.setStyleSheet("padding: 10px; background-color: #FFF9C4; border-radius: 5px;")
        ...
        for i, prompt in enumerate(prompt_examples, 1):
            ...
            prompt_btn.setStyleSheet("text-align: left; padding: 5px;")
        ...
        btn_copy_content.setStyleSheet("background-color: #2196F3; color: white; padding: 8px;")
        ...
        btn_copy_all.setStyleSheet("background-color: #4CAF50; color: white; padding: 8px;")
