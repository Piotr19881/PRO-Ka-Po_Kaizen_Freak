...
class CallCryptorView(QWidget):
    ...
    def _init_sync_infrastructure(self, config):
        ...
        try:
            ...
            api_base_url = getattr(config, 'API_BASE_URL', 'https://prokapo-server-render-1.onrender.com')
    ...
    def apply_theme(self):
        ...
        self.date_filter_combo.setStyleSheet(combo_style)
