    ...
    def add_source(self, source_data: Dict, user_id: str) -> str:
        ...
        cursor.execute("""
            INSERT INTO recording_sources (
                ...
                search_type, search_all_folders, contact_ignore_words,
        ...
        """, (
            ...
            # Persist search_type and search_all_folders for email sources
            source_data.get('search_type', 'SUBJECT'),
            source_data.get('search_all_folders', False),
